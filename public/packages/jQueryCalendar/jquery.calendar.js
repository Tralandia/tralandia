...
var popUpCal = {
	...
	showCalendar: function() {
		...
		var html = (this.closeAtTop ? '<div id="calendar_control">' +
			'<a id="calendar_clear" class="btn btn-info">' + this.clearText + '</a>' +
			'<a id="calendar_close" class="btn btn-info">' + this.closeText + '</a></div>' : '') + 
			'<div id="calendar_links"><a id="calendar_prev" class="btn btn-info">' + this.prevText + '</a>' +
			'<a id="calendar_current" class="btn btn-info">' + this.currentText + '</a>' +
			'<a id="calendar_next" class="btn btn-info">' + this.nextText + '</a></div>' +
		...
		html += '</div>' + timeSelect + '<table id="calendar" cellpadding="0" cellspacing="0" class="table table-condensed"><thead>' +
		...
		html += '</tbody></table><!--[if lte IE 6.5]><iframe src="javascript:false;" id="calendar_cover"></iframe><![endif]-->' +
			...
			(this.closeAtTop ? '' : '<div id="calendar_control"><a id="calendar_clear" class="btn">' + this.clearText + '</a>' +
