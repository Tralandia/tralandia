...
class Utf8_backup {
	...
	function convert($string, $encoding = '', $destination = 'UTF-8') {
		...
		if ($encode_iconv && $dest_iconv) {
			#echo 'icon1';
			return @iconv($encoding, $destination . '//TRANSLIT', $string);
		}
		...
		if ($encode_mb) {
			...
			#echo 'icon2';
			$instring = @iconv($encoding, 'UTF-8' . '//TRANSLIT', $string);
		} else  {
			#echo '=';
			$instring = $string;
		}
		if ($dest_mb) {
			...
			#echo 'iconv3';
			$outstring = @iconv('UTF-8', $destination . '//TRANSLIT', $string);
		} else {
			#echo '=2';
			$outstring = $string;
		}
	...
	function utf82iso88592($text) {
	 $text = str_replace("=C4=85", 'ą', $text);
	 $text = str_replace("=C4=84", 'Ą', $text);
	 $text = str_replace("=C4=87", 'ć', $text);
	 $text = str_replace("=C4=86", 'Ć', $text);
	 $text = str_replace("=C4=99", 'ę', $text);
	 $text = str_replace("=C4=98", 'Ę', $text);
	 $text = str_replace("=C5=82", 'ł', $text);
	 $text = str_replace("=C5=81", 'Ł', $text);
	 $text = str_replace("=C3=B3", 'ó', $text);
	 $text = str_replace("=C3=93", 'Ó', $text);
	 $text = str_replace("=C5=9B", 'ś', $text);
	 $text = str_replace("=C5=9A", 'Ś', $text);
	 $text = str_replace("=C5=BC", 'ż', $text);
	 $text = str_replace("=C5=BB", 'Ż', $text);
	 $text = str_replace("=C5=BA", 'ż', $text);
	 $text = str_replace("=C5=B9", 'Ż', $text);
	 $text = str_replace("=C5=84", 'ń', $text);
	 $text = str_replace("=C5=83", 'Ń', $text);
