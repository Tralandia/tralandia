 ...
 */
class SimpleFrontRouterTest extends BaseRouterTest
{

	/**
	 * @var \Routers\SimpleFrontRoute
	 */
	public $route;

	protected function setUp() {
		$this->route = $this->getContext()->simpleFrontRouteFactory->create();
	}
...
//		$this->routeIn($route, 'http://www.ubytovaniehudak.sk/', NULL);
		...
		$this->routeOut($route, 'RentalList', array(
			'action' => 'default',
			FrontRoute::PRIMARY_LOCATION => $this->findLocation(154),
			FrontRoute::LANGUAGE => $this->findLanguage(38),
			FrontRoute::$pathParametersMapper[FrontRoute::LOCATION] => 58592,
			FrontRoute::$pathParametersMapper[FrontRoute::RENTAL_TYPE] => 6,
